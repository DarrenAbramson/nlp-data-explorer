...
with open("subsetScores", "rb") as f:
    subsetScores = pickle.load(f)
...
# Select out the intended indices

WinograndeQA = [WinograndeQA[i] for i in range(40000) if i not in subsetScores]
...
# the size of the subset indices list is slightly over 9000
